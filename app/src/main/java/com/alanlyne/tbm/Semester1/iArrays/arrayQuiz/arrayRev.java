...
public class arrayRev extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(arrayRev.this, Arrays.class);
            startActivity(x);
        });
    ...
    {
        Intent end = new Intent(arrayRev.this, Arrays.class);
        startActivity(end);
    }
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 5) {
            ...
            Intent myIntent = new Intent(arrayRev.this, arrayRevResult.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("arrayRev").child(String.valueOf(computerCount));
            total++;
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final arrayRevQ questions = dataSnapshot.getValue(arrayRevQ.class);
