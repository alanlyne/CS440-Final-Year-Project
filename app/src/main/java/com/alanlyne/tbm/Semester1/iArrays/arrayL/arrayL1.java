package com.alanlyne.tbm.Semester1.iArrays.arrayL;
...
public class arrayL1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_array_l1);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(arrayL1.this, Arrays.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 8) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(arrayL1.this, Arrays.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(arrayL1.this, Arrays.class);
        startActivity(end);
    }
}