...
public class nloopRev extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(nloopRev.this, nloop.class);
            startActivity(x);
        });
    ...
    {
        Intent end = new Intent(nloopRev.this, nloop.class);
        startActivity(end);
    }
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 5) {
            ...
            Intent myIntent = new Intent(nloopRev.this, nloopRevResult.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("nloopRev").child(String.valueOf(computerCount));
            total++;
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final nloopRevQ questions = dataSnapshot.getValue(nloopRevQ.class);
