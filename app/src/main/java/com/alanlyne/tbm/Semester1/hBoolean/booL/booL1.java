package com.alanlyne.tbm.Semester1.hBoolean.booL;
...
public class booL1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boo_l1);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(booL1.this, Boolean.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 4) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(booL1.this, Boolean.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(booL1.this, Boolean.class);
        startActivity(end);
    }
}