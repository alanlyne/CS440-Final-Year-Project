...
public class stringsL1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strings_l1);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(stringsL1.this, Strings.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 4) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(stringsL1.this, Strings.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(stringsL1.this, Strings.class);
        startActivity(end);
    }
}
