...
public class array2DRev extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(array2DRev.this, Array2D.class);
            startActivity(x);
        });
    ...
    {
        Intent end = new Intent(array2DRev.this, Array2D.class);
        startActivity(end);
    }
        ...
        if (computerCount > 5) {
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final array2DRevQ questions = dataSnapshot.getValue(array2DRevQ.class);
