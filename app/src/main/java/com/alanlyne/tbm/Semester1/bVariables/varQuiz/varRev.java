...
public class varRev extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent x = new Intent(varRev.this, Var.class);
                startActivity(x);
            }
        });
    ...
    {
        Intent end = new Intent(varRev.this, Var.class);
        startActivity(end);
    }
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 2) {
            ...
            Intent myIntent = new Intent(varRev.this, varRevResult.class);
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final varRevQ questions = dataSnapshot.getValue(varRevQ.class);
