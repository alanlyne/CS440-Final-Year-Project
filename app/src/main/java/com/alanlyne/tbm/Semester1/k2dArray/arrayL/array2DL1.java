...
public class array2DL1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(array2DL1.this, Array2D.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 5) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(array2DL1.this, Array2D.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(array2DL1.this, Array2D.class);
        startActivity(end);
    }
}
