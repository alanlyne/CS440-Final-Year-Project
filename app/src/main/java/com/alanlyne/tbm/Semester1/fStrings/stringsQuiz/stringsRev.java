...
public class stringsRev extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(stringsRev.this, Strings.class);
            startActivity(x);
        });
    ...
    {
        Intent end = new Intent(stringsRev.this, Strings.class);
        startActivity(end);
    }
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 5) {
            ...
            Intent myIntent = new Intent(stringsRev.this, stringsRevResult.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("stringsRev").child(String.valueOf(computerCount));
            total++;
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final stringsRevQ questions = dataSnapshot.getValue(stringsRevQ.class);
