...
public class opL2 extends AppCompatActivity {
    TextView t0, t1, t2, t3, t4, t5, x;
    Button b1;
    int counter = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_op_l2);
        ...
        x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent x = new Intent(opL2.this, op.class);
                startActivity(x);
            }
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 5) {
                    ...
                    b1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent Menu = new Intent(opL2.this, op.class);
                            startActivity(Menu);
                            addCounter();
                        }
                    });
    ...
    {
        Intent end = new Intent(opL2.this, op.class);
        startActivity(end);
    }
}