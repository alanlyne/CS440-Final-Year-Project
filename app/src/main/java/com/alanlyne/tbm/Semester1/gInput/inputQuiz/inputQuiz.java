...
public class inputQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(inputQuiz.this, Input.class);
            startActivity(x);
        });
    ...
    {
        Intent end = new Intent(inputQuiz.this, Input.class);
        startActivity(end);
    }
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 5) {
            ...
            Intent myIntent = new Intent(inputQuiz.this, inputQuizResult.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("inputQuiz").child(String.valueOf(computerCount));
            total++;
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final inputQuizQ questions = dataSnapshot.getValue(inputQuizQ.class);
