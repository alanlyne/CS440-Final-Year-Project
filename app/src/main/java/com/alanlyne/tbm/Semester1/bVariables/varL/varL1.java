...
public class varL1 extends AppCompatActivity {
    TextView t, t0, t1, t2, t3, t4, x;
    Button b1;
    int counter = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_var_l1);
        ...
        x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent x = new Intent(varL1.this, Var.class);
                startActivity(x);
            }
        });
                ...
                if (SystemClock.elapsedRealtime() - mLastClickTime < 500) {
                    ...
                    if (counter > 5) {
                        ...
                        b1.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent Menu = new Intent(varL1.this, Var.class);
                                startActivity(Menu);
                                addCounter();
                            }
                        });
    ...
    {
        Intent end = new Intent(varL1.this, Var.class);
        startActivity(end);
    }
}