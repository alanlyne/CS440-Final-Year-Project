...
public class ssL4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ss_l4);
        ...
        x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent x = new Intent(ssL4.this, SS.class);
                startActivity(x);
            }
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 5) {
                    ...
                    b1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent Menu = new Intent(ssL4.this, SS.class);
                            startActivity(Menu);
                            addCounter();
                        }
                    });
    ...
    {
        Intent end = new Intent(ssL4.this, SS.class);
        startActivity(end);
    }
}