package com.alanlyne.tbm.Semester1.cOperators.opQuiz;
...
public class opQuiz extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent x = new Intent(opQuiz.this, op.class);
                startActivity(x);
            }
        });
    ...
    {
        Intent end = new Intent(opQuiz.this, op.class);
        startActivity(end);
    }
        ...
        if (computerCount > 5) {
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final opRevQ questions = dataSnapshot.getValue(opRevQ.class);
