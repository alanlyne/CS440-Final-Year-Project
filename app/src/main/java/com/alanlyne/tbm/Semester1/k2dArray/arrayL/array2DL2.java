...
public class array2DL2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_array2_dl2);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(array2DL2.this, Array2D.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 9) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(array2DL2.this, Array2D.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(array2DL2.this, Array2D.class);
        startActivity(end);
    }
}
