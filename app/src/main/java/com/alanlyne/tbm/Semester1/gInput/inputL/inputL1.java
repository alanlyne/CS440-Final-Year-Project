...
public class inputL1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_l1);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(inputL1.this, Input.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 5) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(inputL1.this, Input.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(inputL1.this, Input.class);
        startActivity(end);
    }
}
