...
public class iterationL2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iteration_l2);
        ...
        x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent x = new Intent(iterationL2.this, Iteration.class);
                startActivity(x);
            }
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 6) {
                    ...
                    b1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent Menu = new Intent(iterationL2.this, Iteration.class);
                            startActivity(Menu);
                            addCounter();
                        }
                    });
    ...
    {
        Intent end = new Intent(iterationL2.this, Iteration.class);
        startActivity(end);
    }
}