...
public class inputL4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_l4);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(inputL4.this, Input.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 4) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(inputL4.this, Input.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(inputL4.this, Input.class);
        startActivity(end);
    }
}
