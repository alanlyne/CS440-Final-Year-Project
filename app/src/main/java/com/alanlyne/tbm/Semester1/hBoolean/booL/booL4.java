...
public class booL4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boo_l4);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(booL4.this, Boolean.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 8) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(booL4.this, Boolean.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
