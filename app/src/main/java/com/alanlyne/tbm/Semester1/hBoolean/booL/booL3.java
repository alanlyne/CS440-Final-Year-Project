...
public class booL3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boo_l3);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(booL3.this, Boolean.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 3) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(booL3.this, Boolean.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(booL3.this, Boolean.class);
        startActivity(end);
    }
}