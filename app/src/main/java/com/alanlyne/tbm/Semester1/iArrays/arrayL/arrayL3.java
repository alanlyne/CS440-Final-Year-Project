...
public class arrayL3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_array_l3);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(arrayL3.this, Arrays.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 4) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(arrayL3.this, Arrays.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(arrayL3.this, Arrays.class);
        startActivity(end);
    }
}
