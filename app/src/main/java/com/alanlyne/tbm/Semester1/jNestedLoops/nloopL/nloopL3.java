...
public class nloopL3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nloop_l3);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(nloopL3.this, nloop.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 4) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(nloopL3.this, nloop.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(nloopL3.this, nloop.class);
        startActivity(end);
    }
}
