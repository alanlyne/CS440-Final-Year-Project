package com.alanlyne.tbm.Semester1.jNestedLoops.nloopQuiz;
...
public class nloopQuiz extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(nloopQuiz.this, nloop.class);
            startActivity(x);
        });
    ...
    {
        Intent end = new Intent(nloopQuiz.this, nloop.class);
        startActivity(end);
    }
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 5) {
            ...
            Intent myIntent = new Intent(nloopQuiz.this, nloopQuizResult.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("nloopQuiz").child(String.valueOf(computerCount));
            total++;
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final nloopQuizQ questions = dataSnapshot.getValue(nloopQuizQ.class);
