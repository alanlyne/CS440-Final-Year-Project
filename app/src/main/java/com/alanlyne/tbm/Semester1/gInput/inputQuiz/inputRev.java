...
public class inputRev extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(inputRev.this, Input.class);
            startActivity(x);
        });
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 2) {
            ...
            Intent myIntent = new Intent(inputRev.this, inputRevResult.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("inputRev").child(String.valueOf(computerCount));
            total++;
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final inputRevQ questions = dataSnapshot.getValue(inputRevQ.class);
