...
public class array2DL4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(array2DL4.this, Array2D.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 4) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(array2DL4.this, Array2D.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(array2DL4.this, Array2D.class);
        startActivity(end);
    }
}