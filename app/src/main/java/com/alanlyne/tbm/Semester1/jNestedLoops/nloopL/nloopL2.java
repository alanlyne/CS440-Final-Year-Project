package com.alanlyne.tbm.Semester1.jNestedLoops.nloopL;
...
public class nloopL2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nloop_l2);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(nloopL2.this, nloop.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 7) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(nloopL2.this, nloop.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
    ...
    {
        Intent end = new Intent(nloopL2.this, nloop.class);
        startActivity(end);
    }
}
