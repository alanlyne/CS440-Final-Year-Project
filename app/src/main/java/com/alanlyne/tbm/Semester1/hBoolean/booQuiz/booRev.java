...
public class booRev extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(booRev.this, Boolean.class);
            startActivity(x);
        });
    ...
    {
        Intent end = new Intent(booRev.this, Boolean.class);
        startActivity(end);
    }
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 5) {
            ...
            Intent myIntent = new Intent(booRev.this, booRevResult.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("booRev").child(String.valueOf(computerCount));
            total++;
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final booRevQ questions = dataSnapshot.getValue(booRevQ.class);
