...
public class nloopL4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nloop_l4);
        ...
        x.setOnClickListener(v -> {
            ...
            Intent x = new Intent(nloopL4.this, nloop.class);
            startActivity(x);
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 8) {
                    ...
                    b1.setOnClickListener(v -> {
                        Intent Menu = new Intent(nloopL4.this, nloop.class);
                        startActivity(Menu);
                        addCounter();
                    });
                }
