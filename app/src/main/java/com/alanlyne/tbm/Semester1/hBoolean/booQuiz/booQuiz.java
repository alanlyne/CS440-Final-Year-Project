...
public class booQuiz extends AppCompatActivity {
    Button b1, b2, b3, b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.setOnClickListener(v -> {
            Intent x = new Intent(booQuiz.this, Boolean.class);
            startActivity(x);
        });
    ...
    {
        Intent end = new Intent(booQuiz.this, Boolean.class);
        startActivity(end);
    }
    ...
    private void updateQuestion() {
        ...
        if (computerCount > 5) {
            ...
            Intent myIntent = new Intent(booQuiz.this, booQuizResult.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("booQuiz").child(String.valueOf(computerCount));
            total++;
            reference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    final booQuizQ questions = dataSnapshot.getValue(booQuizQ.class);
