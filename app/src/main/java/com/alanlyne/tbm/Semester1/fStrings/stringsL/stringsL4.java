...
public class stringsL4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_strings_l4);
        ...
        x.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent x = new Intent(stringsL4.this, Strings.class);
                startActivity(x);
            }
        });
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (counter > 4) {
                    ...
                    b1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent Menu = new Intent(stringsL4.this, Strings.class);
                            startActivity(Menu);
                            addCounter();
                        }
                    });
    ...
    {
        Intent end = new Intent(stringsL4.this, Strings.class);
        startActivity(end);
    }
}